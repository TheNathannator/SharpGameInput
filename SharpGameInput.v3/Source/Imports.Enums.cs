...
namespace SharpGameInput.v3
{
    ...
    // this is positioned as-is from the GameInput header.
    // i don't know why they slapped it into the middle of the button enums lol
    ...
    public static class GameInputGamepadModules
    {
        public const GameInputGamepadButtons SystemDuo =
            GameInputGamepadButtons.Menu |
            GameInputGamepadButtons.View;

        public const GameInputGamepadButtons Dpad =
        ...
        public const GameInputGamepadButtons Shoulders =
            GameInputGamepadButtons.LeftShoulder |
            GameInputGamepadButtons.RightShoulder;

        public const GameInputGamepadButtons Triggers =
            GameInputGamepadButtons.LeftTriggerButton |
            GameInputGamepadButtons.RightTriggerButton;

        public const GameInputGamepadButtons Thumbsticks =
        ...
        public const GameInputGamepadButtons Paddles2 =
            GameInputGamepadButtons.PaddleLeft1 |
            GameInputGamepadButtons.PaddleRight1;

        public const GameInputGamepadButtons Paddles4 =
            GameInputGamepadButtons.PaddleLeft1 |
            GameInputGamepadButtons.PaddleLeft2 |
            GameInputGamepadButtons.PaddleRight1 |
            GameInputGamepadButtons.PaddleRight2;
    }

    public static class GameInputGamepadLayouts
    {
        public const GameInputGamepadButtons Basic =
            GameInputGamepadModules.SystemDuo |
            GameInputGamepadModules.Dpad |
            GameInputGamepadButtons.A |
            GameInputGamepadButtons.B;

        public const GameInputGamepadButtons Buttons =
            Basic |
            GameInputGamepadButtons.X |
            GameInputGamepadButtons.Y |
            GameInputGamepadModules.Shoulders;

        public const GameInputGamepadButtons Standard =
            Buttons |
            GameInputGamepadModules.Triggers |
            GameInputGamepadModules.Thumbsticks |
            GameInputGamepadButtons.LeftThumbstick |
            GameInputGamepadButtons.RightThumbstick;

        public const GameInputGamepadButtons Elite =
            Standard |
            GameInputGamepadModules.Paddles4;
    }
