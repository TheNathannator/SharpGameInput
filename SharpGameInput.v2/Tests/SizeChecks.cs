...
namespace SharpGameInput.v2.Tests;
...
public class SizeChecks
{
    ...
    [Test] public void GameInputSensorsKind() => AssertEnumSize<GameInputSensorsKind>(4);
    [Test] public void GameInputSensorAccuracy() => AssertEnumSize<GameInputSensorAccuracy>(4);
    ...
    public unsafe void GameInputDeviceInfo() => Assert.Multiple(() =>
    {
        ...
        AssertField(instance, instance.arcadeStickInfo,              168);
        AssertField(instance, instance.flightStickInfo,              176);
        AssertField(instance, instance.gamepadInfo,                  184);
        AssertField(instance, instance.racingWheelInfo,              192);
        AssertField(instance, instance.uiNavigationInfo,             200);

        AssertField(instance, instance.controllerAxisCount,      4,  208);
        AssertField(instance, instance._controllerAxisInfo,          216);
        AssertField(instance, instance.controllerButtonCount,    4,  224);
        AssertField(instance, instance._controllerButtonInfo,        232);
        AssertField(instance, instance.controllerSwitchCount,    4,  240);
        AssertField(instance, instance._controllerSwitchInfo,        248);
        AssertField(instance, instance.forceFeedbackMotorCount,  4,  256);
        AssertField(instance, instance._forceFeedbackMotorInfo,      264);
    });
    ...
    public unsafe void GameInputHapticInfo() => Assert.Multiple(() =>
    {
        ...
        AssertSize(instance, 644);
        AssertFixed(instance, instance.audioEndpointId,  0);
        AssertField(instance, instance.locationCount,    512);
